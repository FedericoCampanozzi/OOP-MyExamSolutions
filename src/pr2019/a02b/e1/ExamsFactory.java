...
public interface ExamsFactory {
     ...
     *         (LAB_REGISTER then LAB_EXAM), and in parallel (PROJ_PROPOSE then
     *         PROJ_SUBMIT then PROJ_EXAM) when both have been done, then one can do
     *         FINAL_EVALUATION
     */
     ...
     *         - first need to STUDY, then can proceed - after PROJ_SUBMIT, one has
     *         also to do CSHARP_TASK before actually go to FINAL_EVALUATION
     */
